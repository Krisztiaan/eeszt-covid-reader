const defaultCertificate = `-----BEGIN CERTIFICATE-----
...
// 'https://gist.githubusercontent.com/Krisztiaan/8ef0997a128401c7ad5b2385ef11183a/raw/covidpass-cert.pem';

// todo implement fetching from CERT_URL and store / retrieve with AsyncStorage
export default function useCertificate(): {
  cert: string;
  lastUpdate: ISODateTimeString;
} {
  return { cert: defaultCertificate, lastUpdate: new Date().toISOString() };
}
